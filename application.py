...
<body id="sample">
  <div class="textColumn">
    <h1>Congragulations Prakash</h1>
    <p>Your first AWS Elastic Beanstalk Python Application is now running on your own dedicated PRODUCTION environment in the AWS Cloud</p>
